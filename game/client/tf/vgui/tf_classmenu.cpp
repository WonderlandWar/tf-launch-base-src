...
CTFClassTipsItemPanel::CTFClassTipsItemPanel( Panel *parent, const char *name, int iListItemID ) : BaseClass( parent, name )
{
	...
	m_pTipLabel = new CTFLabel( this, "TipLabel", "" );
}
...
void CTFClassMenu::ApplySchemeSettings( IScheme *pScheme )
{
	...
	m_pSelectAClassLabel = dynamic_cast<CTFLabel*>( FindChildByName( "ClassMenuSelect" ) );
...
const char *g_pszLegacyClassSelectVCDWeapons[TF_LAST_NORMAL_CLASS] =
{
	...
	"tf_weapon_scattergun",					// TF_CLASS_SCOUT,				// weapons handled individually
	"tf_weapon_sniperrifle",				// TF_CLASS_SNIPER,				// weapons handled individually
	"tf_weapon_rocketlauncher",				// TF_CLASS_SOLDIER,			// weapons handled individually
	...
	"tf_weapon_knife",						// TF_CLASS_SPY,				// weapons handled individually
	"tf_weapon_wrench",						// TF_CLASS_ENGINEER,		
};

int g_iLegacyClassSelectWeaponSlots[TF_LAST_NORMAL_CLASS] =
{
	TF_WPN_TYPE_PRIMARY,		// TF_CLASS_UNDEFINED = 0,
	TF_WPN_TYPE_PRIMARY,		// TF_CLASS_SCOUT,			// TF_FIRST_NORMAL_CLASS
	TF_WPN_TYPE_PRIMARY,		// TF_CLASS_SNIPER,
	TF_WPN_TYPE_PRIMARY,		// TF_CLASS_SOLDIER,
	TF_WPN_TYPE_PRIMARY,		// TF_CLASS_DEMOMAN,
	TF_WPN_TYPE_SECONDARY,		// TF_CLASS_MEDIC,
	TF_WPN_TYPE_PRIMARY,		// TF_CLASS_HEAVYWEAPONS,
	TF_WPN_TYPE_PRIMARY,		// TF_CLASS_PYRO,
	TF_WPN_TYPE_MELEE,			// TF_CLASS_SPY,
	TF_WPN_TYPE_MELEE,			// TF_CLASS_ENGINEER,		
};
...
void CTFClassMenu::OnKeyCodePressed( KeyCode code )
{
	...
	else if( code == KEY_XBUTTON_UP || code == KEY_XSTICK1_UP || code == STEAMCONTROLLER_DPAD_UP )
	{
		...
		if ( g_lastPanel )
		{
			RichText *pRichText = dynamic_cast< RichText * >( g_lastPanel->FindChildByName( "classInfo" ) );
