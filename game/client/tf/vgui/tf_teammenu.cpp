...
CTFTeamMenu::CTFTeamMenu( IViewPort *pViewPort ) : CTeamMenu( pViewPort )
{
	...
	m_pHighlanderLabel = new CTFLabel( this, "HighlanderLabel", ""  );
	m_pHighlanderLabelShadow = new CTFLabel( this, "HighlanderLabelShadow", ""  );
	m_pTeamsFullLabel = new CTFLabel( this, "TeamsFullLabel", ""  );
	m_pTeamsFullLabelShadow = new CTFLabel( this, "TeamsFullLabelShadow", "" );
