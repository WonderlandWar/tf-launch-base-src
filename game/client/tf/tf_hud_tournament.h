...
private:
	...
	CTFLabel					*m_pCountdownLabel;
	CTFLabel					*m_pCountdownLabelShadow;
	vgui::ImagePanel			*m_pModeImage;
	
	vgui::ScalableImagePanel	*m_pHudTournamentBG;
	CTFLabel					*m_pTournamentConditionLabel;
...
private:
	...
	CTFButton *m_pReadyButton;
	CTFButton *m_pNotReadyButton;
...
private:
	...
	CTFLabel		 *m_pStopWatchLabel;
	CTFLabel		 *m_pStopWatchScore;
	CTFLabel		 *m_pStopWatchPointsLabel;
	ImagePanel		 *m_pStopWatchImage;
	CTFLabel		 *m_pStopWatchDescriptionLabel;
